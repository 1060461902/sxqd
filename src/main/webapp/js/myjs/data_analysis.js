$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $("span#a").text(data.clockInNum);
            $("span#b").text(data.clockOutNum);
            $("h1#total-num").text(data.studentNum);
            $("span#d").text(data.employeeNum);
            $("span#e").text(data.lastDayAttendNum);
            $("span#f").text(data.companyNum);
            $("span#g").text(data.postNum);
            $("span#h").text(data.headcounts);
        },
        error: function(){
            alert('服务端异常');
        }
