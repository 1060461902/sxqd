...
function getPost() {
	mescroll_sxzp = new MeScroll("mescroll_sxzp", {
		up: {
			...
			toTop: {
				src: "/internshipmgn/wx/assets/images/mescroll-totop.png",
				offset: 1000
			}
		}
	});
					...
					success: function (data) {
						if (data.code === 200) {
							...
							Handlebars.registerHelper('which_img',function (actionName) {
								switch (actionName) {
                                    case '投递简历':
                                        return '/internshipmgn/wx/assets/images/history_send.png';
                                    case '简历通过':
                                        return '/internshipmgn/wx/assets/images/history_pass.png';
                                    case '成功录用':
                                        return '/internshipmgn/wx/assets/images/history_success.png';
                                }
							});
							var html = template(data.data.data);
